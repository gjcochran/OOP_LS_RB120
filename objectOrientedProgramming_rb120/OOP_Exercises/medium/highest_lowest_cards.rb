...
than Queens, and Aces are higher than Kings. The suit plays no part in the relative ranking of cards.
...
#to_s method that returns a String representation of the card, e.g., "Jack of Diamonds", "4 of Clubs", etc.
