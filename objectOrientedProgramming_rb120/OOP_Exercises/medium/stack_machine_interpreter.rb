  ...
  def eval
    @commands.each do |command|
      ...
      when -> (c) { c.to_i != 0 }
        ...
        begin
          raise InvalidTokenError.new("Invalid token: #{command.upcase}")       
...
I think my soluton works well, forgot to add other 2 errors.


**** there are multiple further explorations to attempt... go back and do this again with furthers another time!*****
